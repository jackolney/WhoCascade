ComplexCascade <- function(t, y, parms) {
    ...
    dDx_Cost <- parms[4] * (y[5] + y[6] + y[7] + y[8])
    dCare_Cost <- parms[19] * (y[9] + y[10] + y[11] + y[12])
    dTx_Cost <- parms[5] * (y[13] + y[14] + y[15] + y[16])
    dRetention_Cost <- (parms[7] / 2) * (y[13] + y[14] + y[15] + y[16] + y[17] + y[18] + y[19] + y[20])
