    ...
    column(width = 8,
        box(width = NULL,
            ...
            h4("Plots"),
                ...
                model's best estimate of the current cascade. Each bar represents the mean result of each
                of the accepted parameter sets. Additionally, the error bars illustrate the
                maximum and minimum values generated by the 100 parameter sets. For reference, any available
