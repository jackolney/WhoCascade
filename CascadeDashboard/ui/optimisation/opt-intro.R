    ...
    column(width = 4,
        box(width = NULL,
            ...
            bsButton(inputId = "intFit",
                label = "Best Fitting Parameter Sets",
                type = "action",
                style = "primary",
                size = "default",
                block = TRUE,
        ...
        fluidRow(
            ...
            column(width = 6,
                HTML('<button id="NEXT_optIntro" type="button" class="btn action-button btn-success btn-lg btn-block"> Start <i class="fa fa-play fa-lg fa-fw"></i> </button>')
            )
        )
    )
)
