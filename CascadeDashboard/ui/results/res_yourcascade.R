    ...
    column(width = 8,
        ...
        tabBox(
            ...
            tabPanel(title = "PLHIV",
                tags$h4("Mean number of PLHIV:"),
                uiOutput("outPLHIV"),
                p(""),
                tags$h4("95% Confidence Interval:"),
            ...
            tabPanel(title = "Diagnosed",
                tags$h4("Mean of PLHIV who have been diagnosed:"),
                uiOutput("outDIAG"),
                p(""),
                tags$h4("95% Confidence Interval:"),
            ...
            tabPanel(title = "Care",
                tags$h4("Mean of PLHIV in HIV care (including ART):"),
                uiOutput("outCARE"),
                p(""),
                tags$h4("95% Confidence Interval:"),
            ...
            tabPanel(title = "Treatment",
                tags$h4("Mean of PLHIV in HIV care and on ART:"),
                uiOutput("outART"),
                p(""),
                tags$h4("95% Confidence Interval:"),
            ...
            tabPanel(title = "Suppression",
                tags$h4("Mean of PLHIV in HIV care, on ART and virally suppressed:"),
                uiOutput("outSUPP"),
                p(""),
                tags$h4("95% Confidence Interval:"),
