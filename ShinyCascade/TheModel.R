ComplexCascade <- function(t, y, parms) {
    ...
    dTx_500 <- + parms[5] * y[9] - (parms[7] + parms[6] + parms[10] + parms[18]) * y[13]
    dTx_350500 <- + parms[5] * y[10] + parms[8] * y[15] - (parms[7] + parms[6] + parms[11] + parms[18]) * y[14]
    dTx_200350 <- + parms[5] * y[11] + parms[9] * y[16] - (parms[7] + parms[8] + parms[6] + parms[12] + parms[18]) * y[15]
    dTx_200 <- + parms[5] * y[12] - (parms[7] + parms[9] + parms[6] + parms[13] + parms[18]) * y[16]

    dVs_500 <- + parms[6] * y[13] - (parms[7] + parms[14] + parms[18]) * y[17]
    dVs_350500 <- + parms[6] * y[14] + parms[8] * y[19] - (parms[7] + parms[15] + parms[18]) * y[18]
    dVs_200350 <- + parms[6] * y[15] + parms[9] * y[20] - (parms[7] + parms[8] + parms[16] + parms[18]) * y[19]
    dVs_200 <- + parms[6] * y[16] - (parms[7] + parms[9] + parms[17] + parms[18]) * y[20]

    dLtfu_500 <- + parms[7] * (y[13] + y[17]) - (parms[1] + parms[10] + parms[18]) * y[21]
    dLtfu_350500 <- + parms[7] * (y[14] + y[18]) + parms[1] * y[21] - (parms[2] + parms[11] + parms[18]) * y[22]
    dLtfu_200350 <- + parms[7] * (y[15] + y[19]) + parms[2] * y[22] - (parms[3] + parms[12] + parms[18]) * y[23]
    dLtfu_200 <- + parms[7] * (y[16] + y[20]) + parms[3] * y[23] - (parms[13] + parms[18]) * y[24]
    ...
    dRetention_Cost <- (parms[7] * (y[13] + y[14] + y[15] + y[16] + y[17] + y[18] + y[19] + y[20])) * parms[23]
