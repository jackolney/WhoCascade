...
void Euler(initial * i, params * p, output * o, int start, int stop, double step)
{
	...
	for (double t = start; t < stop; t += step) {
		...
		/* Filling output arrays in */
		o->N[iteration] = i->N;
		o->UnDx_500[iteration] = i->UnDx_500;
		o->UnDx_350500[iteration] = i->UnDx_350500;
		o->UnDx_250350[iteration] = i->UnDx_250350;
		o->UnDx_200250[iteration] = i->UnDx_200250;
		o->UnDx_100200[iteration] = i->UnDx_100200;
		o->UnDx_50100[iteration] = i->UnDx_50100;
		o->UnDx_50[iteration] = i->UnDx_50;
		o->Dx_500[iteration] = i->Dx_500;
		o->Dx_350500[iteration] = i->Dx_350500;
		o->Dx_250350[iteration] = i->Dx_250350;
		o->Dx_200250[iteration] = i->Dx_200250;
		o->Dx_100200[iteration] = i->Dx_100200;
		o->Dx_50100[iteration] = i->Dx_50100;
		o->Dx_50[iteration] = i->Dx_50;
		o->Care_500[iteration] = i->Care_500;
		o->Care_350500[iteration] = i->Care_350500;
		o->Care_250350[iteration] = i->Care_250350;
		o->Care_200250[iteration] = i->Care_200250;
		o->Care_100200[iteration] = i->Care_100200;
		o->Care_50100[iteration] = i->Care_50100;
		o->Care_50[iteration] = i->Care_50;
		o->PreLtfu_500[iteration] = i->PreLtfu_500;
		o->PreLtfu_350500[iteration] = i->PreLtfu_350500;
		o->PreLtfu_250350[iteration] = i->PreLtfu_250350;
		o->PreLtfu_200250[iteration] = i->PreLtfu_200250;
		o->PreLtfu_100200[iteration] = i->PreLtfu_100200;
		o->PreLtfu_50100[iteration] = i->PreLtfu_50100;
		o->PreLtfu_50[iteration] = i->PreLtfu_50;
		o->Tx_Na_500[iteration] = i->Tx_Na_500;
		o->Tx_Na_350500[iteration] = i->Tx_Na_350500;
		o->Tx_Na_250350[iteration] = i->Tx_Na_250350;
		o->Tx_Na_200250[iteration] = i->Tx_Na_200250;
		o->Tx_Na_100200[iteration] = i->Tx_Na_100200;
		o->Tx_Na_50100[iteration] = i->Tx_Na_50100;
		o->Tx_Na_50[iteration] = i->Tx_Na_50;
		o->Tx_A_500[iteration] = i->Tx_A_500;
		o->Tx_A_350500[iteration] = i->Tx_A_350500;
		o->Tx_A_250350[iteration] = i->Tx_A_250350;
		o->Tx_A_200250[iteration] = i->Tx_A_200250;
		o->Tx_A_100200[iteration] = i->Tx_A_100200;
		o->Tx_A_50100[iteration] = i->Tx_A_50100;
		o->Tx_A_50[iteration] = i->Tx_A_50;
		o->Ltfu_500[iteration] = i->Ltfu_500;
		o->Ltfu_350500[iteration] = i->Ltfu_350500;
		o->Ltfu_250350[iteration] = i->Ltfu_250350;
		o->Ltfu_200250[iteration] = i->Ltfu_200250;
		o->Ltfu_100200[iteration] = i->Ltfu_100200;
		o->Ltfu_50100[iteration] = i->Ltfu_50100;
		o->Ltfu_50[iteration] = i->Ltfu_50;
		o->NewInf[iteration] = i->NewInf;
		o->HivMortality[iteration] = i->HivMortality;
		o->NaturalMortality[iteration] = i->NaturalMortality;
		o->Dx_Cost[iteration] = i->Dx_Cost;
		o->Linkage_Cost[iteration] = i->Linkage_Cost;
		o->Annual_Care_Cost[iteration] = i->Annual_Care_Cost;
		o->Annual_ART_Cost[iteration] = i->Annual_ART_Cost;
	}
	cout << "Finished." << endl;
}