...
Initial <- c(
    ...
    Tx_Na_500 = (userTx - userVs) * prop_preART_500,
    Tx_Na_350500 = (userTx - userVs) * prop_preART_350500,
    Tx_Na_250350 = (userTx - userVs) * prop_preART_250350,
    Tx_Na_200250 = (userTx - userVs) * prop_preART_200250,
    Tx_Na_100200 = (userTx - userVs) * prop_preART_100200,
    Tx_Na_50100 = (userTx - userVs) * prop_preART_50100,
    Tx_Na_50 = (userTx - userVs) * prop_preART_50,

    Tx_A_500 = userVs * prop_preART_500,
    Tx_A_350500 = userVs * prop_preART_350500,
    Tx_A_250350 = userVs * prop_preART_250350,
    Tx_A_200250 = userVs * prop_preART_200250,
    Tx_A_100200 = userVs * prop_preART_100200,
    Tx_A_50100 = userVs * prop_preART_50100,
    Tx_A_50 = userVs * prop_preART_50,
