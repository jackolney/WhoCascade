Initial <- c(
    ...
    Tx_Na_500 = 1e+4 * 0 * 0.58,
    Tx_Na_350500 = 1e+4 * 0 * 0.23,
    Tx_Na_200350 = 1e+4 * 0 * 0.16,
    Tx_Na_200 = 1e+4 * 0 * 0.03,
    
    Tx_A_500 = 1e+4 * 0 * 0.58,
    Tx_A_350500 = 1e+4 * 0 * 0.23,
    Tx_A_200350 = 1e+4 * 0 * 0.16,
    Tx_A_200 = 1e+4 * 0 * 0.03,
