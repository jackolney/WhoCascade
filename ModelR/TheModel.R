ComplexCascade <- function(t, y, parms) {
    ...
    dUnDx_500 <- 0.58 * (Beta * (((y[1] + y[5] + y[9] + y[13] + y[17] + y[25]) * 1.35) + ((y[2] + y[6] + y[10] + y[14] + y[18] + y[26]) * 1) + ((y[3] + y[7] + y[11] + y[15] + y[19] + y[27]) * 1.64) + ((y[4] + y[8] + y[12] + y[16] + y[20] + y[28]) * 5.17) + ((y[21] + y[22] + y[23] + y[24]) * 0.1))) - (parms[1] + parms[10] + parms[4] + parms[15] + parms[23]) * y[1]
    dUnDx_350500 <- 0.23 * (Beta * (((y[1] + y[5] + y[9] + y[13] + y[17] + y[25]) * 1.35) + ((y[2] + y[6] + y[10] + y[14] + y[18] + y[26]) * 1) + ((y[3] + y[7] + y[11] + y[15] + y[19] + y[27]) * 1.64) + ((y[4] + y[8] + y[12] + y[16] + y[20] + y[28]) * 5.17) + ((y[21] + y[22] + y[23] + y[24]) * 0.1))) + parms[1] * y[1] - (parms[2] + parms[10] + parms[4] + parms[16] + parms[23]) * y[2]
    dUnDx_200350 <- 0.16 * (Beta * (((y[1] + y[5] + y[9] + y[13] + y[17] + y[25]) * 1.35) + ((y[2] + y[6] + y[10] + y[14] + y[18] + y[26]) * 1) + ((y[3] + y[7] + y[11] + y[15] + y[19] + y[27]) * 1.64) + ((y[4] + y[8] + y[12] + y[16] + y[20] + y[28]) * 5.17) + ((y[21] + y[22] + y[23] + y[24]) * 0.1))) + parms[2] * y[2] - (parms[3] + parms[10] + parms[4] + parms[17] + parms[23]) * y[3]
    dUnDx_200 <- 0.03 * (Beta * (((y[1] + y[5] + y[9] + y[13] + y[17] + y[25]) * 1.35) + ((y[2] + y[6] + y[10] + y[14] + y[18] + y[26]) * 1) + ((y[3] + y[7] + y[11] + y[15] + y[19] + y[27]) * 1.64) + ((y[4] + y[8] + y[12] + y[16] + y[20] + y[28]) * 5.17) + ((y[21] + y[22] + y[23] + y[24]) * 0.1))) + parms[3] * y[3] - (parms[10] + parms[4] + parms[18] + parms[23]) * y[4]
